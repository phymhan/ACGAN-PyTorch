...
CUDA_VISIBLE_DEVICES=3 python mine2.py --dataset cifar10 --dataroot datasets/cifar10 --cuda --batchSize 256 --niter 100 --outf results_new/cifar10/mine2_ln_cn_noa0.2 --use_shared_T --netD_model proj32 --visualize_class_label 9 --netT_model proj32 --use_cy --f_div revkl --loss_type none --no_sn_emb_c --no_sn_emb_l --lambda_r 0.2
...
CUDA_VISIBLE_DEVICES=3 python mine2.py --dataset cifar10 --dataroot datasets/cifar10 --cuda --batchSize 256 --niter 100 --outf results_new/cifar10/mine2_ln_cn_ada0.2 --use_shared_T --netD_model proj32 --visualize_class_label 9 --netT_model proj32 --use_cy --f_div revkl --loss_type none --no_sn_emb_c --no_sn_emb_l --adaptive --lambda_r 0.2
...
CUDA_VISIBLE_DEVICES=3 python mine2.py --dataset cifar10 --dataroot datasets/cifar10 --cuda --batchSize 256 --niter 100 --outf results_new/cifar10/mine2_ls_cs_noa0.2 --use_shared_T --netD_model proj32 --visualize_class_label 9 --netT_model proj32 --use_cy --f_div revkl --loss_type none --lambda_r 0.2
...
CUDA_VISIBLE_DEVICES=3 python mine2.py --dataset cifar10 --dataroot datasets/cifar10 --cuda --batchSize 256 --niter 100 --outf results_new/cifar10/mine2_ls_cs_ada0.2 --use_shared_T --netD_model proj32 --visualize_class_label 9 --netT_model proj32 --use_cy --f_div revkl --loss_type none --adaptive --lambda_r 0.2
