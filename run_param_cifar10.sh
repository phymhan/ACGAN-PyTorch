...
CUDA_VISIBLE_DEVICES=2 python mine.py --dataset cifar10 --dataroot datasets/cifar10 --cuda --batchSize 256 --niter 100 --outf results_new/cifar10/mine_ls_cs_noa1.0 --use_shared_T --netD_model proj32 --loss_type mine --visualize_class_label 9 --netT_model proj32 --use_cy --lambda_mi 1.0

CUDA_VISIBLE_DEVICES=2 python mine.py --dataset cifar10 --dataroot datasets/cifar10 --cuda --batchSize 256 --niter 100 --outf results_new/cifar10/mine_ls_cs_noa2.0 --use_shared_T --netD_model proj32 --loss_type mine --visualize_class_label 9 --netT_model proj32 --use_cy --lambda_mi 2.0
...
CUDA_VISIBLE_DEVICES=2 python mine.py --dataset cifar10 --dataroot datasets/cifar10 --cuda --batchSize 256 --niter 100 --outf results_new/cifar10/mine_ls_cs_ada1.0 --use_shared_T --netD_model proj32 --loss_type mine --visualize_class_label 9 --netT_model proj32 --use_cy --adaptive --adaptive_grad cd --lambda_mi 1.0

CUDA_VISIBLE_DEVICES=2 python mine.py --dataset cifar10 --dataroot datasets/cifar10 --cuda --batchSize 256 --niter 100 --outf results_new/cifar10/mine_ls_cs_ada2.0 --use_shared_T --netD_model proj32 --loss_type mine --visualize_class_label 9 --netT_model proj32 --use_cy --adaptive --adaptive_grad cd --lambda_mi 2.0
